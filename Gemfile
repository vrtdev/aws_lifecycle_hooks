...
group :development do
  ...
  if Gem::Version.new(RUBY_VERSION.dup) != Gem::Version.new('2.1.9')
    gem 'json', '= 1.8.1'
  elsif !Gem::Requirement.create('~> 2.4.2').satisfied_by?(Gem::Version.new(RUBY_VERSION.dup))
    gem 'json', '= 2.0.4'
  elsif !Gem::Requirement.create(['>= 2.5.0', '< 2.7.0']).satisfied_by?(Gem::Version.new(RUBY_VERSION.dup))
    gem 'json', '= 2.1.0'
  end
